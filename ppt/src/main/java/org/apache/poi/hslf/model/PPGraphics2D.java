...
public final class PPGraphics2D extends Graphics2D implements Cloneable {
     ...
     * @see       com.google.code.appengine.awt.Graphics#setFont(Font)
     */
    public Font getFont(){
        return _font;
    }
     ...
     * @see     com.google.code.appengine.awt.Graphics#drawString(java.lang.String, int, int)
     * @see     com.google.code.appengine.awt.Graphics#drawBytes(byte[], int, int, int, int)
     * @see     com.google.code.appengine.awt.Graphics#drawChars(char[], int, int, int, int)
    */
    ...
    public void fillPolygon(int[] xPoints, int[] yPoints,
                            int nPoints){
        com.google.code.appengine.awt.Polygon polygon = new com.google.code.appengine.awt.Polygon(xPoints, yPoints, nPoints);
        fill(polygon);
    }
     ...
     * @param         width   the width of the rectangle to be drawn.
     * @param         height   the height of the rectangle to be drawn.
     * @see          com.google.code.appengine.awt.Graphics#fillRect
     * @see          com.google.code.appengine.awt.Graphics#clearRect
     */
