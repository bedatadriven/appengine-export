...
public final class WMF extends Metafile {
    ...
    public void setData(byte[] data) throws IOException {
        ...
        header.bounds = new com.google.code.appengine.awt.Rectangle((short)aldus.left, (short)aldus.top, (short)aldus.right-(short)aldus.left, (short)aldus.bottom-(short)aldus.top);
        //coefficient to translate from WMF dpi to 96pdi
        int coeff = 96*Shape.EMU_PER_POINT/aldus.inch;
        header.size = new com.google.code.appengine.awt.Dimension(header.bounds.width*coeff, header.bounds.height*coeff);
