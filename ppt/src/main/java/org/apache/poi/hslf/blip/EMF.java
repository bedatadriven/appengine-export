...
public final class EMF extends Metafile {
    ...
    public void setData(byte[] data) throws IOException {
        ...
        header.bounds = new com.google.code.appengine.awt.Rectangle(0, 0, 200, 200);
        header.size = new com.google.code.appengine.awt.Dimension(header.bounds.width*Shape.EMU_PER_POINT, header.bounds.height*Shape.EMU_PER_POINT);
