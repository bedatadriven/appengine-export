    ...
    * @param idx the index of the picture
    ...
    public void setDefaultSize(){
        ...
        if (pict  instanceof Bitmap){
            ...
            setAnchor(new com.google.code.appengine.awt.Rectangle(50, 50, 200, 200));
        }
    }
    ...
    protected void afterInsert(Sheet sh){
        ...
        com.google.code.appengine.awt.Rectangle anchor = getAnchor();
        if (anchor.equals(new com.google.code.appengine.awt.Rectangle())){
            setDefaultSize();
        }
    }
