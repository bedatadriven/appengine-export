...
public abstract class FontTable {
     ...
     * com.google.code.appengine.awt.Font[family=Dialog,name=dialog.bold,style=plain,size=20]
     * becomes
     * com.google.code.appengine.awt.Font[family=Dialog,name=Dialog,style=bold,size=20]
     *
     * @param attributes
     */
