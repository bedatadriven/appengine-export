/*
 * $Id: Image.java 3004 2007-11-21 15:24:27Z blowagie $
 * $Name$
 *
...
public abstract class Image extends Rectangle {
    ...
    // images from a com.google.code.appengine.awt.Image
    
	/**
	 * Gets an instance of an Image from a com.google.code.appengine.awt.Image.
	 * 
	 * @param image
	 *            the <CODE>com.google.code.appengine.awt.Image</CODE> to convert
	 * @param color
	...
	public static Image getInstance(com.google.code.appengine.awt.Image image, com.google.code.appengine.awt.Color color,
		...
		try {
			...
			throw new IOException(
					"com.google.code.appengine.awt.Image Interrupted waiting for pixels!");
		}
	...
	/**
	 * Gets an instance of a Image from a com.google.code.appengine.awt.Image.
	 ...
	 * @throws IOException
	 */
	public static Image getInstance(PdfWriter writer, com.google.code.appengine.awt.Image awtImage, float quality) throws BadElementException, IOException {
     ...
     * @throws IOException
     */
    public static Image getInstance(PdfContentByte cb, com.google.code.appengine.awt.Image awtImage, float quality) throws BadElementException, IOException {
        com.google.code.appengine.awt.image.PixelGrabber pg = new com.google.code.appengine.awt.image.PixelGrabber(awtImage,
                0, 0, -1, -1, true);
        try {
            pg.grabPixels();
        } catch (InterruptedException e) {
