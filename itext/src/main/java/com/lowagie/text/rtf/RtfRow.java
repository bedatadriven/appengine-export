...
public class RtfRow {
    ...
    private com.google.code.appengine.awt.Color borderColor = null;
    ...
    public boolean importRow(Row row, float[] propWidths, int tableWidth, int pageWidth, int cellpadding,
                             int cellspacing, int borders, com.google.code.appengine.awt.Color borderColor, float borderWidth,
                             int y) {
