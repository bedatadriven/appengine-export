/*
 * $Id: PdfGraphics2D.java 2976 2007-11-08 14:55:41Z psoares33 $
 *
...
import com.google.code.appengine.awt.RenderingHints.Key;
...
public class PdfGraphics2D extends Graphics2D {
    ...
    public void drawString(String s, float x, float y) {
        ...
        setFillPaint();
        if (onlyShapes) {
            drawGlyphVector(this.font.layoutGlyphVector(getFontRenderContext(), s.toCharArray(), 0, s.length(), com.google.code.appengine.awt.Font.LAYOUT_LEFT_TO_RIGHT), x, y);
...
*/
    ...
    private synchronized void waitForImage(com.google.code.appengine.awt.Image image) {
