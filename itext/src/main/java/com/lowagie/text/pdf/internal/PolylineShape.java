...
public class PolylineShape implements Shape {
	 ...
	 * @see com.google.code.appengine.awt.Shape#getBounds2D()
	 */
	...
	/**
	 * Returns the bounding box of this polyline.
	 * @see com.google.code.appengine.awt.Shape#getBounds()
	 */
	 ...
	 * @see com.google.code.appengine.awt.Shape#contains(double, double)
	 */
	public boolean contains(double x, double y) { return false; }
	
	/**
	 * A polyline can't contain a point.
	 * @see com.google.code.appengine.awt.Shape#contains(com.google.code.appengine.awt.geom.Point2D)
	 */
	public boolean contains(Point2D p) { return false; }
	
	/**
	 * A polyline can't contain a point.
	 * @see com.google.code.appengine.awt.Shape#contains(double, double, double, double)
	 */
	public boolean contains(double x, double y, double w, double h) { return false; }
	
	/**
	 * A polyline can't contain a point.
	 * @see com.google.code.appengine.awt.Shape#contains(com.google.code.appengine.awt.geom.Rectangle2D)
	 */
	 ...
	 * @see com.google.code.appengine.awt.Shape#intersects(double, double, double, double)
	 */
