...
public class AcroFields {
     ...
     * <li>textcolor - sets the text color. The value for this entry is a <CODE>com.google.code.appengine.awt.Color</CODE>.<br>
     * <li>textsize - sets the text size. The value for this entry is a <CODE>Float</CODE>.
     * <li>bgcolor - sets the background color. The value for this entry is a <CODE>com.google.code.appengine.awt.Color</CODE>.
     *     If <code>null</code> removes the background.<br>
     * <li>bordercolor - sets the border color. The value for this entry is a <CODE>com.google.code.appengine.awt.Color</CODE>.
