...
/**
 * Draws arabic text using com.google.code.appengine.awt.Graphics2D
 */
public class ArabicText {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            com.google.code.appengine.awt.Font font = new com.google.code.appengine.awt.Font("arial", 0, 18);
            PdfContentByte cb = writer.getDirectContent();
            com.google.code.appengine.awt.Graphics2D g2 = cb.createGraphicsShapes(PageSize.A4.getWidth(), PageSize.A4.getHeight());
            g2.setFont(font);
